      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary nav-ts">
        <div className="container-fluid">
          <a className="navbar-brand fw-bold" href="/">
            <img
              src="https://socialfollow.co/assets/img/socialfollow-logo.svg"
              alt=""
              width="400"
              height="30"
            />
              ...
              <div className="sf-panel">
                <div className="body">
                  ...
                  <p className={`text main `}>
                    Simply enter your username and email to proceed.
                  </p>
                  <form className="sf-form" onSubmit={handleOnSubmit}>
                    <div className="row">
